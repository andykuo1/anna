...
> The browser-based solution for a lambda calculus transpiler.

---

## Purpose
A simple lambda calculus editor inspired by Elsa. Plain and simple.
...
This is required to edit the program remotely. Just get the current version and install it. The repository is hosted at [GitHub](https://github.com/andykuo1/anna).
...
Then, clone the [repo](https://github.com/andykuo1/anna.git) to the directory.

```
git clone https://github.com/andykuo1/anna.git
```
